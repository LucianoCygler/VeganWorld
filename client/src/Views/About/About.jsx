    ...
    >
      ...
      >
        ...
        <Text
          ...
          color="white"
        >
          Comes from our own needs. We wanted an app that could make it easier to be
          a vegan and order food like everybody else. So we teamed up and built our
          own company to facilitate this. And we couldn't be happier about the
          results.
        </Text>
        <Text
          as="h2"
          ...
          color="green.200"
        >
          Day after day more than 3000 orders from our website are being completed.
          And that means that a lot of people are eating healthy and delicious food.
        </Text>
        <Flex
        flexDirection="row"
        alignItems="center"
