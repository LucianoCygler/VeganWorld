        ...
        <>
            <form onSubmit={submitHandler}>
                <div className="div--form">
                    ...
                    <input className="input" type="text" name='title' onChange={handleChange} value={input.value}/>
                    <span className="span--form">{error.name}</span>
                </div>
                <div className="div--form">
                    <label htmlFor="desc" className="label">Name: </label>
                    <input className="input" type="text" name='desc' onChange={handleChange} value={input.value}/>
                    <span className="span--form">{error.name}</span>
                </div>
