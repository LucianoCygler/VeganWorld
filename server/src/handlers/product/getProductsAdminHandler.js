...
const getAllProductsAdmin = require("../../controllers/product/getAllProductsAdmin");
...
const getProductsAdminHandler = async (req, res) => {
  const { nombre, sort, filterByType } = req.query;
  try {
    let orderedProduct = await getAllProductsAdmin();
...
module.exports = getProductsAdminHandler;
